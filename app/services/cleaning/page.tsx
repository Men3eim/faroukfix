      ...
      <header className="sticky top-0 z-50 w-full border-b border-blue-200/50 bg-white/95 backdrop-blur-sm">
        <div className="container flex h-16 items-center justify-between px-4">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/services/cleaning" className="text-sm font-medium text-blue-600">
              Cleaning
            </Link>
        ...
        <div className="container px-4">
          <div className="grid gap-8 md:grid-cols-4">
            <div>
              ...
              <p className="text-sm text-slate-600">Professional cleaning services across W2 & W3 London areas.</p>
            </div>

            <div>
              <h3 className="font-semibold mb-4 text-slate-900">Cleaning Services</h3>
